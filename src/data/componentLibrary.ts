...
export const COMPONENT_TEMPLATES: ComponentTemplate[] = [
  ...
  },
  {
    ...
    defaultPorts: [
      { name: '+24V (1)', type: 'electrical', functionType: 'power_24v', x: 13.3, y: 61.9 },
      { name: '+24V (2)', type: 'electrical', functionType: 'power_24v', x: 31.4, y: 61.9 },
      { name: '+24V (3)', type: 'electrical', functionType: 'power_24v', x: 50.0, y: 61.9 },
      { name: '+24V (4)', type: 'electrical', functionType: 'power_24v', x: 68.6, y: 61.9 },
      { name: '+24V (5)', type: 'electrical', functionType: 'power_24v', x: 86.7, y: 61.9 },
      { name: '0V (1)', type: 'electrical', functionType: 'ground_0v', x: 13.3, y: 87.6 },
      { name: '0V (2)', type: 'electrical', functionType: 'ground_0v', x: 31.4, y: 87.6 },
      { name: '0V (3)', type: 'electrical', functionType: 'ground_0v', x: 50.0, y: 87.6 },
      { name: '0V (4)', type: 'electrical', functionType: 'ground_0v', x: 68.6, y: 87.6 },
      { name: '0V (5)', type: 'electrical', functionType: 'ground_0v', x: 86.7, y: 87.6 },
    ],
    defaultState: {
      activated: true,
      voltageV: 24.0,
  ...
  },
  {
    ...
    defaultPorts: [
      { name: 'NF (21)', type: 'electrical', functionType: 'signal_in', x: 30, y: 75 },
      { name: 'NF (22)', type: 'electrical', functionType: 'signal_out', x: 70, y: 75 },
    ],
    defaultState: {
      isEmergencyTriggered: false
    }
