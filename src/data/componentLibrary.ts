...
export const COMPONENT_TEMPLATES: ComponentTemplate[] = [
  ...
  },
  {
    ...
    height: 180,
    tagPrefix: 'K1',
    description: 'Módulo didático industrial com relé auxiliar de 3 contatos reversíveis (3 contatos NA e 3 contatos NF alinhados na vertical), bornes de segurança 4mm para bobina A1/A2, LED indicador amarelo de acionamento posicionado entre A1 e A2 e esquema elétrico serigrafado conforme norma IEC.',
    defaultPorts: [
      { name: 'A1 (+)', type: 'electrical', functionType: 'signal_in', x: 14.0, y: 32.22 },
      { name: 'A2 (-)', type: 'electrical', functionType: 'ground_0v', x: 14.0, y: 81.11 },
      { name: '11 (Comum 1)', type: 'electrical', functionType: 'signal_in', x: 38.0, y: 32.22 },
      { name: '12 (NF 1)', type: 'electrical', functionType: 'signal_out', x: 38.0, y: 56.67 },
      { name: '14 (NA 1)', type: 'electrical', functionType: 'signal_out', x: 38.0, y: 81.11 },
      { name: '21 (Comum 2)', type: 'electrical', functionType: 'signal_in', x: 62.0, y: 32.22 },
      { name: '22 (NF 2)', type: 'electrical', functionType: 'signal_out', x: 62.0, y: 56.67 },
      { name: '24 (NA 2)', type: 'electrical', functionType: 'signal_out', x: 62.0, y: 81.11 },
      { name: '31 (Comum 3)', type: 'electrical', functionType: 'signal_in', x: 86.0, y: 32.22 },
      { name: '32 (NF 3)', type: 'electrical', functionType: 'signal_out', x: 86.0, y: 56.67 },
      { name: '34 (NA 3)', type: 'electrical', functionType: 'signal_out', x: 86.0, y: 81.11 },
    ],
    defaultState: {
      activated: false,
      temperatureC: 25
