...
export const COMPONENT_TEMPLATES: ComponentTemplate[] = [
  ...
  },
  {
    ...
    name: 'Fonte de Alimentação Fixa 24V DC / 5A (PELV)',
    category: 'supply',
    width: 150,
    height: 160,
    tagPrefix: '0G',
    description: 'Fonte industrial estabilizada restrita a 24V DC com proteção contra curto-circuito (PELV / IEC 60204-1 / NR-12).',
    defaultPorts: [
      { name: '+24V (A)', type: 'electrical', functionType: 'power_24v', x: 30, y: 40 },
      { name: '+24V (B)', type: 'electrical', functionType: 'power_24v', x: 30, y: 75 },
      { name: '0V (A)', type: 'electrical', functionType: 'ground_0v', x: 70, y: 40 },
      { name: '0V (B)', type: 'electrical', functionType: 'ground_0v', x: 70, y: 75 },
    ],
    defaultState: {
      activated: true,
      voltageV: 24.0,
